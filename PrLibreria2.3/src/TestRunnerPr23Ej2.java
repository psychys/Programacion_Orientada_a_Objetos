...
import PrLibreria.LibroOferta;
import PrLibreria.OfertaAutor;
import PrLibreria.OfertaFlex;
import PrLibreria.OfertaPrecio;
...
public class TestRunnerPr23Ej2 {
	...
	public static class JUnitTestLibreriaOfertaFlex {
		private static final String[] autoresOferta = { "george orwell", "isaac asimov" };
		private OfertaAutor oa1;
		private PruebaLibreriaOfertaFlex lrof1;
		@BeforeClass
		public static void beforeClass() {
			// Code executed before the first test method
		...
		public void setUp() {
			// Code executed before each test
			oa1 = new OfertaAutor(20.0, autoresOferta);
			lrof1 = new PruebaLibreriaOfertaFlex(2, oa1);
		}
		@After
		public void tearDown() {
			// Code executed after each test
		...
		public void libreriaOfertaFlexCtorTest2() {
			PruebaLibreriaOfertaFlex lrof2 = new PruebaLibreriaOfertaFlex(oa1);
